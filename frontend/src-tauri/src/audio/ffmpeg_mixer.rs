...
/// Enable microphone speech enhancement. On macOS this selects
/// DeepFilterNet3; other platforms retain the lightweight RNNoise fallback.
pub const RNNOISE_APPLY_ENABLED: bool = cfg!(target_os = "macos");
